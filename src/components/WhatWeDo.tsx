...
const WhatWeDo = () => {
  return (
    <section className="max-w-4xl mx-auto px-6 py-8 bg-white shadow-md rounded-lg border border-light text-center">
      <h2 className="text-2xl font-bold text-gray-900 mb-6 border-b-2 border-lighter pb-2">
        ❓ What All Do You Do?
      </h2>
      <p className="text-lg text-primary mb-6">
        The short answer? <strong>Everything!</strong> If there&rsquo;s something you&rsquo;ve been wanting to do but need help with, we can help you get it done!
      </p>
      ...
      <p className="mt-4 text-lg text-gray-900 font-bold">
        If it&rsquo;s been on your mind, reach out! We&rsquo;ve probably done it before.
      </p>
    </section>
  );
};
